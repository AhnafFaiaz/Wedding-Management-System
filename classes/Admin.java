...
{
	public static String adminId="admin";  //'admin' is the id to log in
	public static String password="admin";  //'admin' is the password to log in
	public boolean temp=false;
	 Employee employees[]=new Employee[30];
	
	public Admin(){}
	public Admin(String adminId, String password)   //This is for security
	{
	...
	public void addEmployee(Employee emp)           //This method is to add an employee
	{
		int flag=0;
		//try {
	...
	public void removeEmployee(int id)          //This method is to remove an employee by calling their ID
	{
		int flag=0;
		/*try{*/
			for(int i=0;i<employees.length;i++)
	...
	public void showEmployees()                     //this method is to view all the employee details
	{
        for(int i=0;i<employees.length;i++)
		{
			if (employees[i]!=null)
	...
	public void createTeam(int teamno,int a,int b)  //This method is to create only one Team consisting only two members
	{
